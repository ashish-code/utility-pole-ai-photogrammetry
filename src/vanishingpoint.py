...
if __name__ == "__main__":
    input_image_dir_path = 'data/vanishingpoint/'
    output_image_dir_path = "result/vanishingpoint/"
    Images, ImageNames = ReadImage(input_image_dir_path)            # Reading all input images
    ...
    for i in range(len(Images)):
        ...
        output_image_path = output_image_dir_path + image_name
